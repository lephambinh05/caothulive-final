...
// Initialize Firebase Admin SDK - Compatible Version
if (!admin.apps.length) {
  try {
    ...
    console.log('✅ Firebase Admin initialized with service account key (Compatible Version)');
  } catch (error) {
  ...
  db = admin.firestore();
  firebaseInitialized = true;
  console.log('✅ Firebase Admin already initialized (Compatible Version)');
}
